...
In order to support loading of multiple wallets in civitas-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is civitas.cpp.
...
Changes to civitas.cpp
----------------------
civitas.cpp is the entry point into civitas-qt, and as such, will require some minor modifications to provide hooks for
