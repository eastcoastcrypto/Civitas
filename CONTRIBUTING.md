Contributing to Civitas Core
============================

The Civitas Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Civitas Core project, and is not to be
confused with overall Civitas Network Protocol consensus changes.

Whether a pull request is merged into Civitas Core rests with the project merge
...
Patches that change Civitas consensus rules are considerably more involved than
...
Where a patch set proposes to change the Civitas consensus, it must have been
...
The project leader is the release manager for each Civitas Core release.
