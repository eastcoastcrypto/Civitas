...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Civitas server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Civitas features */
        {"civitas", "masternode", &masternode, true, true, false},
        {"civitas", "listmasternodes", &listmasternodes, true, true, false},
        {"civitas", "getmasternodecount", &getmasternodecount, true, true, false},
        {"civitas", "masternodeconnect", &masternodeconnect, true, true, false},
        {"civitas", "masternodecurrent", &masternodecurrent, true, true, false},
        {"civitas", "masternodedebug", &masternodedebug, true, true, false},
        {"civitas", "startmasternode", &startmasternode, true, true, false},
        {"civitas", "createmasternodekey", &createmasternodekey, true, true, false},
        {"civitas", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"civitas", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"civitas", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"civitas", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"civitas", "getmasternodescores", &getmasternodescores, true, true, false},
        {"civitas", "mnbudget", &mnbudget, true, true, false},
        {"civitas", "preparebudget", &preparebudget, true, true, false},
        {"civitas", "submitbudget", &submitbudget, true, true, false},
        {"civitas", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"civitas", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"civitas", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"civitas", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"civitas", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"civitas", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"civitas", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"civitas", "checkbudgets", &checkbudgets, true, true, false},
        {"civitas", "mnsync", &mnsync, true, true, false},
        {"civitas", "spork", &spork, true, true, false},
        {"civitas", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"civitas", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use civitasd, or the -server option to civitas-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> civitas-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:28843/\n";
}
