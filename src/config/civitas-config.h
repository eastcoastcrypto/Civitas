/* src/config/civitas-config.h.  Generated from civitas-config.h.in by configure.  */
/* src/config/civitas-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.civitas.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Civitas Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Civitas Core 1.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "civitas"
