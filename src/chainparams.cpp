...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000186b7f1ac681548e1be4b72e1f5e489a2c3a7d0650eed27ec7c286b6e90"));
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 18843;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Civitas starting difficulty is 1 / 2^12
        ...
        nZerocoinStartHeight = 21600;
        nZerocoinStartTime = 1516665600; // 2018-01-23T00:00Z
        nBlockEnforceSerialRange = 14403; //Enforce serial range starting this block
        nBlockRecalculateAccumulators = 14405; //Trigger a recalculation of accumulators
        nBlockFirstFraudulent = 14402; //First block that bad serials emerged
        nBlockLastGoodCheckpoint = 14405; //Last valid accumulator checkpoint
...
public:
    CTestNetParams()
    {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet civitas addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet civitas script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet civitas BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet civitas BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet civitas BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Civitas: 1 day
        nTargetSpacing = 1 * 60;        // Civitas: 1 minutes
