                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Civitas Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Civitas address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and civitas: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zCIV"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Civitas Core"), this);
    aboutAction->setStatusTip(tr("Show information about Civitas Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Civitas"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Civitas addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Civitas addresses"));
    ...
    openAction->setStatusTip(tr("Open a Civitas: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Civitas Core help message to get a list with possible Civitas command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Civitas Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Civitas network", "", count));
}
...
{
    QString strTitle = tr("Civitas Core"); // default title
