                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Civ from zCiv"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zCiv"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zCiv));
