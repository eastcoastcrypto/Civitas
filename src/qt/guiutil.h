...
/** Utility functions used by the Civitas Qt UI.
 */
namespace GUIUtil
{
...
// Render Civitas addresses in monospace font
...
// Parse "civitas:" URI into recipient object, return true on successful parsing
